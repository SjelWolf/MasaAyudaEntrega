...
session_start();
if(!empty($_SESSION)){
print_r($_SESSION);} else {echo'prueba';}
?>
...
<body>
  ...
  <main>
    <div class="container-main">
     ...
     <iframe class="iframe" src="https://www.youtube.com/embed/jhDDv1QVgio?autoplay=1&mute=1" title="YouTube video player" 
             frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
        <!--https://www.youtube.com/embed/Aqg3hZTpg1k?autoplay=1&mute=1 ->>
<!--https://www.youtube.com/watch?v=jhDDv1QVgio -->
      <div class="menucrud">
        <div class="vis sec1">
