...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-04-2021 a las 04:07:22
...
(37, '2021-04-09 18:02:00', 'prueba de requerimiento', 35, '1', '6', NULL),
(39, '2021-04-09 19:35:38', 'Prueba de Radicacion de Requerimientos', 37, '1', '6', NULL);
...
('2', 'Brandon Camilo Castrillon', 'C:xampphtdocsproyectoMesaAyudavistaft3.pdf', 'C:xampphtdocsproyectoMesaAyudavistahvs3.pdf', '499', 'brandon@gmail.com', 'Carrera 74 D sur 57 -24', -96.144, 32.555, '3', '10'),
...
('6', 'Juan José Diez Rico', 'C:xampphtdocsproyectoMesaAyudavistaft3.pdf', 'C:xampphtdocsproyectoMesaAyudavistahvs3.pdf', '57241', 'juan@gmail.com', 'Carrera 48 #46-35', 58.6589, -41.25789, NULL, '40'),
...
--
ALTER TABLE `cargo`
  MODIFY `IDCARGO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
...
--
ALTER TABLE `requerimiento`
  MODIFY `IDREQ` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
